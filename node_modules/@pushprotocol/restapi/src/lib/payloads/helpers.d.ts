...
export declare function getVerificationProof({ senderType, signer, chainId, notificationType, identityType, verifyingContract, payload, ipfsHash, graph, uuid, chatId, wallet, //
pgpPrivateKey, //
env, }: {
    senderType: 0 | 1;
    signer: any;
