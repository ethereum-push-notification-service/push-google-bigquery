...
const helpers_3 = require("../chat/helpers");
/**
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            */
            ...
            const wallet = (0, helpers_3.getWallet)({ account: null, signer });
            ...
            const source = (0, helpers_1.getSource)(chainId, identityType, senderType);
            const apiPayload = {
                verificationProof,
                identity,
                sender: senderType === 1
