...
const decryptPGPKey = (options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const { encryptedPGPPrivateKey, account = null, signer = null, env = constants_1.default.ENV.PROD, toUpgrade = false, progressHook, } = options || {};
    try {
...
const encryptV3 = (data, secret, additionalData) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
const encryptPGPKey = (encryptionType, privateKey, address, wallet) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    var _c, _d;
    ...
    switch (encryptionType) {
        ...
        case constants_1.default.ENC_TYPE_V3: {
            ...
            encryptedPrivateKey = yield (0, exports.encryptV3)(encodedPrivateKey, (0, exports.hexToBytes)(secret || ''));
...
const verifyPGPPublicKey = (encryptionType, publicKey, did, nftOwner) => {
    if (encryptionType === constants_1.default.ENC_TYPE_V2 ||
        encryptionType === constants_1.default.ENC_TYPE_V3) {
        ...
        if ((0, signature_1.verifyProfileSignature)(verificationProof, signedData, (0, address_1.pCAIP10ToWallet)(did), nftOwner ? (0, address_1.pCAIP10ToWallet)(nftOwner) : nftOwner))
            return publicKey;
        else
            throw new Error('Cannot verify Encryption Keys for this user');
    }
    return publicKey;
};
