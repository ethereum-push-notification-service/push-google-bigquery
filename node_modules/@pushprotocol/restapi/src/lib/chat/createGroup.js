...
const createGroup = (options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const { account = null, signer = null, groupName, groupDescription, members, groupImage, admins, isPublic, contractAddressNFT, numberOfNFTs, contractAddressERC20, numberOfERC20, env = constants_1.default.ENV.PROD, pgpPrivateKey = null, meta, } = options || {};
    try {
        ...
        const bodyToBeHashed = {
            ...
            groupCreator: (0, helpers_1.walletToPCAIP10)(address),
        };
        const connectedUser = yield (0, helpers_2.getConnectedUser)(wallet, pgpPrivateKey, env);
        ...
        const body = (0, helpers_2.createGroupPayload)(groupName, groupDescription, convertedMembers, groupImage, convertedAdmins, isPublic, (0, helpers_1.walletToPCAIP10)(address), verificationProof, contractAddressNFT, numberOfNFTs, contractAddressERC20, numberOfERC20, meta);
