...
const approve = (options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const bodyToBeHashed = {
        fromDID: isGroup
            ? (0, helpers_1.walletToPCAIP10)(address)
            : (0, helpers_1.walletToPCAIP10)(senderAddress),
        toDID: isGroup ? senderAddress : (0, helpers_1.walletToPCAIP10)(address),
        status: status,
    };
    ...
    const body = (0, helpers_2.approveRequestPayload)(senderAddress, address, status, 'pgp', signature);
