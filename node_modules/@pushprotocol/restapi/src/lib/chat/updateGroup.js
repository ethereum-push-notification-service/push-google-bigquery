...
const updateGroup = (options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const body = (0, helpers_2.updateGroupPayload)(groupName, groupImage, groupDescription, convertedMembers, convertedAdmins, (0, helpers_1.walletToPCAIP10)(address), verificationProof);
