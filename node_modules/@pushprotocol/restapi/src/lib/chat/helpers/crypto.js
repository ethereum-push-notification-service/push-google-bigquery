...
const getEip191Signature = (wallet, message) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const signedMessage = yield (_signer === null || _signer === void 0 ? void 0 : _signer.signMessage(message));
